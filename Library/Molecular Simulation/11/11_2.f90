program mcnpt ! npt simulation of hard-spheres
	...
	real*8 :: r2, att1, att2, xn, yn, zn, dispmax = 1d0, dvol = 1d-2, dispvol = 1d0, avv1, avv2, press = 1d0
    real*8 :: vnew, vold, iboxold, boxold, box = 1d1, ibox = 1d-1, dx, dy, dz, mvo1, mvo2, r1

    call random_seed()
	open (10, file = '11_2.dat')
    ! initialize 
	att1 = 0.0d0
	att2 = 0.0d0
	avv1 = 0.0d0
