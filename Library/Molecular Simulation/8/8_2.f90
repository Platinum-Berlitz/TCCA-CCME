...
integer i
integer, parameter :: npart = 100, equil = 100, ndispl = 50, prod = 5000
...
program mc_nvt
    ! gfortran 8_2.f90 -o 8_2 && ./8_2
	use mc
	implicit none
	integer ii, icycl, attempt, nacc, ncycl, imove, kkk
	real*8 :: en, ent, vir, virt, av1 = 0, av2 = 0, press, bv1 = 0, bv2 = 0, cv1 = 0, dv1 = 0

	open (20, file = '8_2.dat')
	! initialize sysem
	call lattice()
	...
	do ii = 1, 2
		...
		if (ii==2) then
			write (20, *) (cv1/av2 - (dv1/av2)**2)*beta**2
